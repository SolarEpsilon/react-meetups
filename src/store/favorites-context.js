...
export function FavoritesContextProvider(props) {
  ...
  function removeFavoriteHandler(meetupId) {
    // If meetupId is not equal to the current id, we keep it. If it is equal, we filter it out. Basically, it selects every ID other than our favorite and puts in in the new array that we keep:
    setUserFavorites((prevUserFavorites) => {
